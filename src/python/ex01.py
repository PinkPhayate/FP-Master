...
def predict(ver, predict_ver,  alike_metrics):
    ...
    for i in tqdm(range(ITER)):
        ...
        X_resampled, y_resampled = training_m.product_df.as_matrix().tolist(), training_m.fault.as_matrix().tolist()
        ...
        X_resampled, y_resampled = training_m.mrg_df.as_matrix().tolist(), training_m.fault.as_matrix().tolist()
        model = predictor.train_model( X_resampled, y_resampled )
        ...
        X_resampled, y_resampled = alike_df.as_matrix().tolist(), training_m.fault.as_matrix().tolist()
        model = predictor.train_model( X_resampled, y_resampled )
